...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> handleMatriculaAlreadyExistsException(MatriculaAlreadyExistsException exception) {
        ErrorDetails errorDetails = new ErrorDetails(
                LocalDateTime.now(),
    ...
    public ResponseEntity<ErrorDetails> handleFeignException(FeignException exception) {
        ErrorDetails errorDetails = new ErrorDetails(
                LocalDateTime.now(),
                exception.status(),
                "Error en comunicación con microservicio",
                exception.getMessage()
        );
